...
const emit = defineEmits(['update:nombre', 'update:email', 'update:propietario', 'update:alta', 'update:sintomas', 'guardar-paciente'])
...
<template>
    <div class="md:w-1/2">
        ...
        <form @submit.prevent="validar" class="bg-white shadow-md rounded-lg py-10 px-5 mb-10">
            ...
            <div class="mb-5">
                <label for="síntomas" class="block text-gray-700 uppercase font-bold">
                    Síntomas
                </label>
                <textarea id="síntomas" placeholder="Describe los síntomas del paciente"
